-- Fix get_distribution_data to calculate balances from transactions ledger instead of cached_balances
...
BEGIN
  ...
  -- FIXED: Calculate balances from transactions ledger, NOT from cached_balances
  ...
  FROM (
    SELECT 
      ...
      -- FIXED: Calculate balances from transactions ledger (authoritative source)
      (
